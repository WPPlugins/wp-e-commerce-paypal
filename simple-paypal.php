...
function simplepaypal_activate() {
	$options = get_option('simplepaypal_options');
	$sourceFile = dirname(__FILE__).'/simple-paypal.merchant.php';
...
function simplepaypal_render_form() {
	...
	<div class="wrap">
		...
		if(!file_exists($destinationFile)) {
			...
			echo '<li><span style="color:red;">Copier le fichier '.dirname(__FILE__).'/simple-paypal.merchant.php vers '.$destinationFile.' <a href="'.$nonce_url.'">en cliquant ici</a></span></li>';
		} 
		else {
		...
		echo '<li>Install Zend first : http://h6e.net/wiki/wordpress/plugins/zend-framework to have acces to new features</li>';	
		}?>
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<td><input type="text" size="57" name="simplepaypal_options[notify_url]" value="<?php echo $options['notify_url']; ?>" /></td>
				</tr>
				<tr>
		...
		$nonce_url=wp_nonce_url(__WPUrl__.'/wp-admin/options-general.php?page=wp-e-commerce-paypal/simple-paypal.php&action=copymerchant');
		echo '<li>Developpeur : Copier le fichier '.dirname(__FILE__).'/simple-paypal.merchant.php vers '.$destinationFile.' <a href="'.$nonce_url.'">en cliquant ici</a></li>';
		?>
